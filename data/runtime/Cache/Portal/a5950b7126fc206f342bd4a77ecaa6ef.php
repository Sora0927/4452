...
<div class="container">
	...
	<div>
		<h1 class="text-center">快速了解推推网</h1>
		<h3 class="text-center">Quickly understand the tuituinet</h3>
	</div>
	<div class="row">
		<div class="span4">
			 <h2 class="font-large nospace"><i class="fa fa-bars"></i> 校内生活</h2>
             <p>讲座、校内兼职、拼车、自习、旅游、美食、购物、借车、校内交易</p>
		</div>
		<div class="span4">
			 <h2 class="font-large nospace"><i class="fa fa-group"></i> 校外生活</h2>
             <p>校外兼职类，旅游攻略，美食攻略，招聘类，娱乐类，创业类</p>
		</div>
		<div class="span4">
			  <h2 class="font-large nospace"><i class="fa fa-cloud"></i> 志愿者招募</h2>
              <p>分为校内招募及校外招募，校内招募主要为各学院的志愿者活动推送，方便学院开展志愿者活动，为川大学子提供了解各类志愿者活动的平台</p>
		</div>
	</div>
