	...
	<div class="row">
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
				...
				<?php if($isactive == 1 ): ?><div>
				<b>报名人数：<span style="color:red"><?php echo ($applycount); ?>/<?php echo ($activecount); ?></span></b>
				</div><?php endif; ?>
		    	...
		    	<div>
    	            ...
    	            <script type="text/javascript" src="/tpl/simplebootx/Public/js/qrcode.min.js"></script>
				...
				<?php $nowdate=time(); $s=strtotime($activestarttime); $f=strtotime($activefinishtime); ?>
				<?php if($isactive == 1 ): if($applycount == $activecount): ?>报名人数已满额！
					<?php elseif($f-$nowdate < 0): ?>
					报名时间已截止！
					<?php elseif($nowdate-$s < 0): ?>
					报名时间未开始！
					
					<?php else: ?>
					<?php echo JoinUs("posts",$object_id); endif; endif; ?>
