...
$(".activetime").hide();
          ...
          <td>
		  <input type="text" name="post[activestarttime]" id="activestarttime" value="<?php echo date('Y-m-d H:i:s',time());?>" size="21" class="input length_3 J_datetime" style="width: 160px;">
		 -<input type="text" name="post[activefinishtime]" id="activefinishtime" value="<?php echo date('Y-m-d H:i:s',time());?>" size="21" class="input length_3 J_datetime" style="width: 160px;">
		 </td>
        </tr>		  
            <tr>
		  <tr class="activetime">
