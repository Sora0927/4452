...
<div class="container tc-main">
    ...
    <div class="row">
		<div class="span9">
			<div class="">
				<?php $lists = sp_sql_posts("field:post_title,post_excerpt,tid,smeta;order:applycount DESC;",array("isactive"=>1)); $top10=get_top_user(); ?>
				<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>
				
				<div class="list-boxes">
					<h2><a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">第<span style="color:red"><b><?php echo ($key+1); ?></b></span>名：<?php echo ($vo["post_title"]); ?></a></h2>
	...
	<?php if(is_array($top10)): $i = 0; $__LIST__ = $top10;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h2><a href="#">第<span style="color:red"><b><?php echo ($key+1); ?></b></span>名：<?php echo ($vo["user_login"]); ?></a></h2>
					<p>共参与活动<span style="color:red"><b><?php echo ($vo["top10"]); ?></b></span>次</p>
		...
		<div class="span3">
        	...
        	<div class="tc-box">
	        	...
	        	<div class="ranking">
	        		<?php $hot_articles=sp_sql_posts("field:post_title,post_excerpt,tid,smeta;order:applycount desc;limit:5;",array("isactive"=>1)); ?>
		        	<ul class="unstyled">
        	...
        	<div class="tc-box">
	        	...
	        	<div class="ranking">
	        		<?php $hot_articles=sp_sql_posts("cid:$portal_index_lastnews;field:post_title,post_excerpt,tid,smeta;order:post_hits desc;limit:5;",array("isactive"=>0)); ?>
		        	<ul class="unstyled">
		        		<?php if(is_array($hot_articles)): foreach($hot_articles as $key=>$vo): $top=$key<3?"top3":""; ?>
							<li class="<?php echo ($top); ?>"><i><?php echo ($key+1); ?></i><a title="<?php echo ($vo["post_title"]); ?>" href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a></li><?php endforeach; endif; ?>
					</ul>
